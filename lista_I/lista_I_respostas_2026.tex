...
\midrule
$\uparrow\theta$ & $-$ & $-$ & $-$ &
  $\rstar=\rho+\theta g$ sobe $\Rightarrow$ $f'(\kstar)\uparrow$ $\Rightarrow$ $\kstar\downarrow$ \\[2pt]
$\uparrow\rho$ & $-$ & $-$ & $-$ &
  Mais impaciente $\Rightarrow$ menos poupança, menor capital \\[2pt]
$\uparrow n$ & $-$ & $-$ & $-$ &
  Mais pessoas diluem capital por trabalhador \\[2pt]
$\uparrow g$ & $-$ & $?$ & $?$ &
  $\rstar=\rho+\theta g$ sobe; efeito sobre $\cstar$ ambíguo \\
\bottomrule
\end{tabular}
\end{table}
