...
\begin{tcolorbox}[standard, colback=correctbg, colframe=correctborder,
  ...
  top=6pt, bottom=6pt]
\centering
\textbf{\textcolor{correctborder}{Gabarito Oficial (divulgado pelo docente em 16/07/2026)}}\\[0.6em]
...
\bottomrule
\end{tabular}\\[0.5em]
{\footnotesize O gabarito reconstruído deste documento coincidiu
\textbf{12/12} com o oficial --- inclusive Q9 e Q12, que haviam sido
sinalizadas com ambiguidade de redação.}
\end{tcolorbox}
...
\vfill
{\small Gabarito reconstruído a partir das chaves oficiais da P2 2024 e da
Lista 3 2026, das respostas da P2 2021 e dos slides das Aulas 10--13 ---
posteriormente \textbf{confirmado na íntegra pelo gabarito oficial} divulgado
pelo docente às turmas 01D/01M em 16/07/2026.}
\end{center}
\end{titlepage}
...
\begin{correctbox}[title={Resposta: iv) --- confirmada pelo gabarito oficial}]
...
\emph{Confirmação}: o gabarito oficial validou \textbf{iv} --- o
``positivamente'' do item ii era, de fato, o veneno intencional na cauda do
item.
\end{correctbox}
...
\begin{correctbox}[title={Resposta: ii) Apenas A, B e C --- confirmada pelo gabarito oficial}]
...
\emph{Confirmação}: o gabarito oficial validou \textbf{ii} --- a leitura
econômica padrão prevaleceu: C é verdadeira pela teoria das expectativas da
estrutura a termo.
\end{correctbox}
...
P1). O gabarito reconstruído de forma independente coincidiu \textbf{12/12}
com o gabarito oficial divulgado pelo docente em 16/07/2026 (ii, iii, iii,
iv, iv, i, iii, ii, iv, iv, ii, ii). Conferência detalhada da prova
preenchida e nota final em
